...
- `ENVIRONMENT.md` - developer setup and runtime configuration
- `TESTING.md` - test plan, cases, results, and evidence locations
...
- `TEAM.md` - group members and contribution summary
- `TRACEABILITY.md` - requirements to design, code, and tests

## Process evidence

- `process/README.md` - how to record evidence
- `process/EVIDENCE_INDEX.md` - evidence index
