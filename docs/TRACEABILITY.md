...
| FR-TASK-1      | Project and task management           | SRS 4.3 SF-TASK    | TBD                                                                                                                                                              | TBD                                        | Planned     |
| FR-VIEW-1      | Multi-view boards                     | SRS 4.4 SF-VIEW    | TBD                                                                                                                                                              | TBD                                        | Planned     |
| FR-ATT-1       | Attachments vault                     | SRS 4.5 SF-ATT     | TBD                                                                                                                                                              | TBD                                        | Planned     |
| FR-DASH-1      | Personal dashboard                    | SRS 4.6 SF-DASH    | TBD                                                                                                                                                              | TBD                                        | Planned     |
